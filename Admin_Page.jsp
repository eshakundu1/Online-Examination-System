...
<html>
	...
	<body>
		<form name="f1" method="get" action="Admin_Back.jsp">
			...
			<table>
				<tr>
			      	<td>Teacher Name</td><td><input type="text" name="t1" placeholder="enter name"></td>
			    </tr>
				<tr>
			      	<td>User ID</td><td><input type="text" name="t2" placeholder="enter userid"></td>
			    </tr>
			    <tr>
			      	<td>Password</td><td><input type="password" name="t3" placeholder="enter password"></td>
			    </tr>
			    <tr>
			      	<td>Subject Name</td><td><input type="text" name="t4" placeholder="enter subject name"></td>
			    </tr>
			    <tr>
				<td colspan="2">
